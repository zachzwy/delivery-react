...
export default function Form({
  ...
  return (
    <div className="form-container">
      <form className={`form ${uiState.classOfForm}`} onSubmit={handleSubmit}>
        ...
        <label className={uiState.classOfDate}>
          ...
          >
            ...
            <option value="12/19/2019/0900AM-1200AM">
              12/19/2019 --- 09:00AM - 12:OOAM --- $30
            </option>
            <option value="12/20/2019/0900AM-1200AM">
              12/20/2019 --- 09:00AM - 12:OOAM --- $30
            </option>
            <option value="12/21/2019/0900AM-1200AM">
              12/21/2019 --- 09:00AM - 12:OOAM --- $30
            </option>
            <option value="12/22/2019/0900AM-1200AM">
              12/22/2019 --- 09:00AM - 12:OOAM --- $30
            </option>
        ...
        <label className={uiState.classOfCustomizedDate}>
          ...
          <span className="quote">{inputs.quote}</span>
        </label>
      ...
      {state.currentUser ? (
        <div className={uiState.classOfAfterSubmit}>
          <div className="thanks">{`THANKS, ${state.currentUser.name.toUpperCase()}. WE WILL CONFIRM WITH YOU SHORTLY.`}</div>
        </div>
      ) : null}
    </div>
  );
